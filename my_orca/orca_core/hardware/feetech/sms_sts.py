...
class sms_sts(protocol_packet_handler):
    ...
    def LockEprom(self, scs_id):
        # EEPROM writes are slow — use TxOnly to avoid response timeout
        return self.write1ByteTxOnly(scs_id, SMS_STS_LOCK, 1)

    def unLockEprom(self, scs_id):
        return self.write1ByteTxOnly(scs_id, SMS_STS_LOCK, 0)
